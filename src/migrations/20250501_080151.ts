...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_preferences_default_timeframe" AS ENUM('all', 'year', 'month', 'week', 'last30');
  CREATE TYPE "public"."enum_users_preferences_default_chart_view" AS ENUM('grid', 'list', 'timeline');
  CREATE TYPE "public"."enum_tags_color" AS ENUM('#FF5252', '#4CAF50', '#2196F3', '#FFEB3B', '#9C27B0', '#FF9800', '#009688', '#E91E63', '#9E9E9E');
  CREATE TYPE "public"."enum_charts_timeframe" AS ENUM('daily', 'weekly', 'monthly', 'intraday', 'other');
  CREATE TYPE "public"."enum_trades_exits_reason" AS ENUM('strength', 'stop', 'backstop', 'violation', 'other');
  CREATE TYPE "public"."enum_trades_type" AS ENUM('long', 'short');
  CREATE TYPE "public"."enum_trades_setup_type" AS ENUM('breakout', 'pullback', 'reversal', 'gap', 'other');
  CREATE TYPE "public"."enum_trades_status" AS ENUM('open', 'closed', 'partial');
  CREATE TYPE "public"."enum_donations_currency" AS ENUM('CZK', 'EUR', 'USD');
  ...
  CREATE TABLE IF NOT EXISTS "users" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  	"preferences_default_timeframe" "enum_users_preferences_default_timeframe" DEFAULT 'month',
  	"preferences_default_chart_view" "enum_users_preferences_default_chart_view" DEFAULT 'grid',
  	"preferences_target_position_size" numeric DEFAULT 25000,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "tags" (
  	...
  	"description" varchar,
  	"color" "enum_tags_color" DEFAULT '#9E9E9E' NOT NULL,
  	"charts_count" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "tickers_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "charts_measurements" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "charts" (
  	...
  	"timeframe" "enum_charts_timeframe" DEFAULT 'daily' NOT NULL,
  	"notes_setup_entry" varchar,
  	"notes_trend" varchar,
  	"notes_fundamentals" varchar,
  	"notes_other" varchar,
  	"annotations" jsonb,
  	"annotated_image_id" integer,
  	"keyboard_nav_id" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE IF NOT EXISTS "charts_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "trades_modified_stops" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "trades_exits" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"price" numeric NOT NULL,
  	...
  	"date" timestamp(3) with time zone NOT NULL,
  	"reason" "enum_trades_exits_reason",
  	"notes" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "trades" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"ticker_id" integer NOT NULL,
  	"type" "enum_trades_type" DEFAULT 'long' NOT NULL,
  	"entry_date" timestamp(3) with time zone NOT NULL,
  	"entry_price" numeric NOT NULL,
  	"shares" numeric NOT NULL,
  	"initial_stop_loss" numeric NOT NULL,
  	"setup_type" "enum_trades_setup_type",
  	"current_price" numeric,
  	"current_metrics_profit_loss_amount" numeric,
  	"current_metrics_profit_loss_percent" numeric,
  	"current_metrics_r_ratio" numeric,
  	"current_metrics_risk_amount" numeric,
  	"current_metrics_risk_percent" numeric,
  	"current_metrics_break_even_shares" numeric,
  	"current_metrics_last_updated" timestamp(3) with time zone,
  	"status" "enum_trades_status" DEFAULT 'open' NOT NULL,
  	"notes" varchar,
  	"risk_amount" numeric,
  	...
  	"normalized_metrics_profit_loss_amount" numeric,
  	"normalized_metrics_profit_loss_percent" numeric,
  	"normalized_metrics_r_ratio" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE IF NOT EXISTS "trades_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "donations" (
  	...
  	"currency" "enum_donations_currency" DEFAULT 'CZK' NOT NULL,
  	"status" "enum_donations_status" DEFAULT 'initiated' NOT NULL,
  	"transaction_id" varchar,
  	"payment_id" varchar,
  	"donor_name" varchar,
  	"donor_email" varchar,
  	"donor_message" varchar,
  	"metadata" jsonb,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "tickers_rels" ADD CONSTRAINT "tickers_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."tickers"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "tickers_rels" ADD CONSTRAINT "tickers_rels_tags_fk" FOREIGN KEY ("tags_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "charts_measurements" ADD CONSTRAINT "charts_measurements_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."charts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "charts" ADD CONSTRAINT "charts_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "charts" ADD CONSTRAINT "charts_ticker_id_tickers_id_fk" FOREIGN KEY ("ticker_id") REFERENCES "public"."tickers"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "charts" ADD CONSTRAINT "charts_annotated_image_id_media_id_fk" FOREIGN KEY ("annotated_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "charts_rels" ADD CONSTRAINT "charts_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."charts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "charts_rels" ADD CONSTRAINT "charts_rels_tags_fk" FOREIGN KEY ("tags_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "trades_modified_stops" ADD CONSTRAINT "trades_modified_stops_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."trades"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "trades_exits" ADD CONSTRAINT "trades_exits_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."trades"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "trades" ADD CONSTRAINT "trades_ticker_id_tickers_id_fk" FOREIGN KEY ("ticker_id") REFERENCES "public"."tickers"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "trades_rels" ADD CONSTRAINT "trades_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."trades"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "trades_rels" ADD CONSTRAINT "trades_rels_charts_fk" FOREIGN KEY ("charts_id") REFERENCES "public"."charts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_charts_fk" FOREIGN KEY ("charts_id") REFERENCES "public"."charts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_trades_fk" FOREIGN KEY ("trades_id") REFERENCES "public"."trades"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "tickers_symbol_idx" ON "tickers" USING btree ("symbol");
  CREATE INDEX IF NOT EXISTS "tickers_updated_at_idx" ON "tickers" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "tickers_created_at_idx" ON "tickers" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "tickers_rels_order_idx" ON "tickers_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "tickers_rels_parent_idx" ON "tickers_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "tickers_rels_path_idx" ON "tickers_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "tickers_rels_tags_id_idx" ON "tickers_rels" USING btree ("tags_id");
  CREATE INDEX IF NOT EXISTS "charts_measurements_order_idx" ON "charts_measurements" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "charts_measurements_parent_id_idx" ON "charts_measurements" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "charts_image_idx" ON "charts" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "charts_ticker_idx" ON "charts" USING btree ("ticker_id");
  CREATE INDEX IF NOT EXISTS "charts_annotated_image_idx" ON "charts" USING btree ("annotated_image_id");
  CREATE INDEX IF NOT EXISTS "charts_updated_at_idx" ON "charts" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "charts_created_at_idx" ON "charts" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "charts_rels_order_idx" ON "charts_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "charts_rels_parent_idx" ON "charts_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "charts_rels_path_idx" ON "charts_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "charts_rels_tags_id_idx" ON "charts_rels" USING btree ("tags_id");
  CREATE INDEX IF NOT EXISTS "trades_modified_stops_order_idx" ON "trades_modified_stops" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "trades_modified_stops_parent_id_idx" ON "trades_modified_stops" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "trades_exits_order_idx" ON "trades_exits" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "trades_exits_parent_id_idx" ON "trades_exits" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "trades_ticker_idx" ON "trades" USING btree ("ticker_id");
  CREATE INDEX IF NOT EXISTS "trades_updated_at_idx" ON "trades" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "trades_created_at_idx" ON "trades" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "trades_rels_order_idx" ON "trades_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "trades_rels_parent_idx" ON "trades_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "trades_rels_path_idx" ON "trades_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "trades_rels_charts_id_idx" ON "trades_rels" USING btree ("charts_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_tickers_id_idx" ON "payload_locked_documents_rels" USING btree ("tickers_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_charts_id_idx" ON "payload_locked_documents_rels" USING btree ("charts_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_trades_id_idx" ON "payload_locked_documents_rels" USING btree ("trades_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "tickers_rels" CASCADE;
  DROP TABLE "charts_measurements" CASCADE;
  DROP TABLE "charts" CASCADE;
  DROP TABLE "charts_rels" CASCADE;
  DROP TABLE "trades_modified_stops" CASCADE;
  DROP TABLE "trades_exits" CASCADE;
  DROP TABLE "trades" CASCADE;
  DROP TABLE "trades_rels" CASCADE;
  ...
  DROP TYPE "public"."enum_users_preferences_default_timeframe";
  DROP TYPE "public"."enum_users_preferences_default_chart_view";
  DROP TYPE "public"."enum_tags_color";
  DROP TYPE "public"."enum_charts_timeframe";
  DROP TYPE "public"."enum_trades_exits_reason";
  DROP TYPE "public"."enum_trades_type";
  DROP TYPE "public"."enum_trades_setup_type";
  DROP TYPE "public"."enum_trades_status";
  DROP TYPE "public"."enum_donations_currency";
